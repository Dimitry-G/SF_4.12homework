...
DB_PATH = "sqlite3:///sochi_athletes.sqlite3"
...
def request_data():
    print('Поиск атлетов похожих на пользователей')
...
def nearest_by_db(user, session):
...
def main():
    ...
    if not user:
        ...
        bd_athlete, bd = nearest_by_db(user, session)
